...
using namespace std;        //jakoukoliv fci, co napisu za tento radek, bude hledat ve standartni knihovne => není nutno pak předepisovat před každou fci
...
{\
    std::cout <<"Zdravím, jak se vede?" << std::endl;     //cokoliv za cout vypisime, vykresli obrazovku cokoliv, co tam napiseme
